...
create index `idx_ingredient_group_recipe_id` on `ingredient_group` (`recipe_id`);
create index `idx_ingredient_ingredient_group_id` on `ingredient` (`ingredient_group_id`);
create index `idx_step_group_recipe_id` on `step_group` (`recipe_id`);
